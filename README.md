...
본 프로젝트 **Picky.AI**는 개인 프로젝트로서 기능 구현을 마무리하고 종료할 예정입니다.  
향후에는 **PickyBiz.AI**라는 확장 프로젝트로 발전시켜,  

- 물류 회사 시스템과의 연동 기반 자동화 AI  
- 가격 예측 및 광고 성과 분석/추천 기능  

등 **비즈니스 의사결정을 지원하는 기능**을 추가하여 새롭게 업로드할 계획입니다.
